cc.Class({
    ...
    initHandlers:function(){
        ...
        cc.vv.net.addHandler("gang_notify_push",function(data){
            ...
            ////ZZZ
            for(var i = 0; i <  self.seats.length; ++i){
              //  self.seats[i].score = gangScore == 0? 0:gangScore[i].changeScore;
            }
            self.doGang(si,pai,data);
        });
    ...
    doGang:function(seatIndex,pai,data){
        ...
        console.log("data.gangScore"+data.gangScore);
        this.dispatchEvent('gang_notify',{seatData:seatData,gangtype:gangtype,gangScore:data.gangScore});
    },
