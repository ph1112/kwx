cc.Class({
    ...
    onLoad: function () {
		...
		this._btbg1=this.node.getChildByName("bg1");
		this._btbg2=this.node.getChildByName("bg2");
    ...
    initVolue:function()
    {
        ...
        var userData1 = JSON.parse(cc.sys.localStorage.getItem(key1));
		 var userData2 = JSON.parse(cc.sys.localStorage.getItem(key2));
		...
		this._btbg1.getComponent("RadioButton").checked=false;
		this._btbg1.getComponent("RadioButton").checked=false;
		switch (userData2) {
                 case 0:
                     this._btbg1.getComponent("RadioButton").checked=true;
                    break;
                case 1:
                     this._btbg2.getComponent("RadioButton").checked=true;
                    break;
