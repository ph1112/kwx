cc.Class({
    ...
    initSeatsGang: function (gangScore) {
        for (var i = 0; i < cc.vv.gameNetMgr.seats.length; ++i) {
           //console.log(" gangScore[i].finalScore  "+ gangScore[i].finalScore);
          // console.log(" cc.vv.gameNetMgr.seats[i].name  "+ cc.vv.gameNetMgr.seats[i].name);
           ...
           //ZZZ
           //this._seats2[index].setInfo(cc.vv.gameNetMgr.seats[i].name, gangScore[i].finalScore);
           //this._seats[index].setInfo( cc.vv.gameNetMgr.seats[i].name, gangScore[i].finalScore);
        }
    },
    ...
    //每个位置加减分数，动作
    addFenSeatsAction:function(ScoreArr_p){
        for(var i = 0; i < ScoreArr_p.length; ++i){
            var localIdx = cc.vv.gameNetMgr.getLocalIndex(i);
            if(ScoreArr_p[i].changeScore != 0){
            this._seats2[localIdx].piaoFeng(ScoreArr_p[i].changeScore);
            
            
            //  console.log("localIdx  "+localIdx)
            // console.log("1  cc.vv.gameNetMgr.seats[i].score  "+cc.vv.gameNetMgr.seats[i].score)
            // cc.vv.gameNetMgr.seats[i].score+=ScoreArr_p[i].changeScore;
            // console.log("2  ScoreArr_p[i].changeScore  "+ScoreArr_p[i].changeScore)
            // console.log("2  cc.vv.gameNetMgr.seats[i].score  "+cc.vv.gameNetMgr.seats[i].score)
            }       
        }
    },
